...
**从 0.2.1 或更早版本升级时请注意：**安装新版后，必须手动在“系统设置 → 隐私与安全性”中的“辅助功能”和“屏幕与系统音频录制”（部分 macOS 版本显示为“屏幕录制”）列表里分别选中旧版 Oh My Tab 并点“−”删除，再点“+”从“应用程序”添加新版 `Oh-My-Tab.app`，并开启这两项权限。仅关闭再打开原有开关不能完成重新授权。完成后重新启动 Oh My Tab。
